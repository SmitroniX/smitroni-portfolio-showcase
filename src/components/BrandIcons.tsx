...
/* =========================================================================
   ...
   Vector brand icons for Java, Python, C++, C, JavaScript, TypeScript,
   Rust, Go, and Bash
   ========================================================================= */

// Java (Official Oracle / Sun coffee cup with red steam swirl & blue saucer)
export const JavaIcon: React.FC<IconProps> = ({ className = "w-4 h-4", ...props }) => (
...
// Python (Official dual blue & yellow interlocking snakes)
export const PythonIcon: React.FC<IconProps> = ({ className = "w-4 h-4", ...props }) => (
  <svg viewBox="0 0 128 128" className={className} {...props}>
    <defs>
      <linearGradient id="py-grad-blue" x1="0%" y1="0%" x2="100%" y2="100%">
        <stop offset="0%" stopColor="#5A9FD4" />
        <stop offset="100%" stopColor="#306998" />
      </linearGradient>
      <linearGradient id="py-grad-yellow" x1="0%" y1="0%" x2="100%" y2="100%">
...
// C++ (Official ISO C++ blue hexagon with white C and ++)
export const CppIcon: React.FC<IconProps> = ({ className = "w-4 h-4", ...props }) => (
  <svg viewBox="0 0 128 128" className={className} {...props}>
...
// C (Official ISO C blue hexagon shield with white C)
export const CIcon: React.FC<IconProps> = ({ className = "w-4 h-4", ...props }) => (
  <svg viewBox="0 0 128 128" className={className} {...props}>
    <path fill="#00599C" d="M118.766 95.82c.89-1.543 1.441-3.28 1.441-4.843V36.78c0-1.558-.55-3.297-1.441-4.84l-55.32 31.94Zm0 0" />
    <path fill="#004482" d="m68.36 126.586 46.933-27.094c1.352-.781 2.582-2.129 3.473-3.672l-55.32-31.94L8.12 95.82c.89 1.543 2.121 2.89 3.473 3.672l46.933 27.094c2.703 1.562 7.13 1.562 9.832 0Zm0 0" />
    <path fill="#659AD2" d="M118.766 31.941c-.891-1.546-2.121-2.894-3.473-3.671L68.359 1.172c-2.703-1.563-7.129-1.563-9.832 0L11.594 28.27C8.89 29.828 6.68 33.66 6.68 36.78v54.196c0 1.562.55 3.3 1.441 4.843L63.445 63.88Zm0 0" />
...
// JavaScript (Official yellow badge with black JS lettering)
export const JavaScriptIcon: React.FC<IconProps> = ({ className = "w-4 h-4", ...props }) => (
  <svg viewBox="0 0 128 128" className={className} {...props}>
...
// TypeScript (Official blue badge with white TS lettering)
export const TypeScriptIcon: React.FC<IconProps> = ({ className = "w-4 h-4", ...props }) => (
  <svg viewBox="0 0 128 128" className={className} {...props}>
...
// Rust (Official gear cog wheel with stylized R)
export const RustIcon: React.FC<IconProps> = ({ className = "w-4 h-4", ...props }) => (
  <svg viewBox="0 0 128 128" className={className} {...props}>
    <path
      fill="#DEA584"
...
// Go (Official Golang cyan speed-line GO lettering)
export const GoIcon: React.FC<IconProps> = ({ className = "w-4 h-4", ...props }) => (
  <svg viewBox="0 0 128 128" className={className} {...props}>
...
// Bash (Official GNU Bash terminal box with bright green prompt & cursor)
export const BashIcon: React.FC<IconProps> = ({ className = "w-4 h-4", ...props }) => (
  <svg viewBox="0 0 128 128" className={className} {...props}>
    <rect width="120" height="120" x="4" y="4" rx="20" fill="#20252C" stroke="#3B4252" strokeWidth="6" />
    <path
      d="M30 40 L58 64 L30 88"
      fill="none"
      stroke="#4EAA25"
      strokeWidth="11"
      strokeLinecap="round"
